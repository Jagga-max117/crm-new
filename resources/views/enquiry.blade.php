                    ...
                    <div class="col-lg-12 grid-margin stretch-card">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form class="cmxform" id="signupform" method="POST" action="{{route('submitenquiry')}}" enctype="multipart/form-data">
                                    {{csrf_field()}}
                                    <div class="row">
                                        <div class="col-md-6">
                                            ...
                                            <fieldset>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select name="study_level" id="study_level" class="btn btn-secondary form-control">
                                                        ...
                                                        <option value="{{ $item->program_type_id }}">{{ $item->program_type }}</option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                                <div class="form-group">
                                                    ...
                                                    <select class="btn btn-secondary form-control" name="course_of_study" id="course_of_study">
                                                        ...
                                                        <option value="{{ $item->course_id }}">{{$item->course}}</option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                                <div class="form-group">
                                                    ...
                                                    <select class="btn btn-secondary form-control" name="how_did_you_hear_about_ieis" id="how_did_you_hear_about_ieis">
                                                        ...
                                                        <option value="{{ $item->information_id }}">{{$item->information}}</option>
                                                        @endforeach
                                        ...
                                        <div class="col-md-6">
                                            <fieldset>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input id="phone_number" class="form-control" name="phone_number" type="numeric">
                                                </div>
                                                <div class="form-group">
                                                    ...
                                                    <select class="btn btn-secondary form-control" name="subject_area" id="subject_area">
                                                        ...
                                                        <option value="{{ $item->subject_area_id }}">{{$item->subject_area}}</option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                                <div class="form-group">
                                                    ...
                                                    <select class="btn btn-secondary form-control" name="preferred_school" id="preferred_school">
                                                        ...
                                                        <option value="{{ $item->school_id }}">{{$item->school}}</option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                                <div class="form-group">

...
<body class="sidebar-dark">
    <div class="main-wrapper">
        ...
        <div class="d-flex justify-content-between align-items-center flex-wrap grid-margin">
          <div>
            <h4 class="mb-3 mb-md-0">Welcome to the Employee Dashboard</h4>
          </div>
                  ...
                  <div class="card-body">
                    ...
                    <div class="row">
                      <div class="col-6 col-md-12 col-xl-12">
                        <p>
                          <h3 class="card-title mt-4">Total Employees</h3>
                        </p>
                      </div>
                    </div>
                  </div>
                ...
                <div class="card">
                  <div class="card-body">
                    ...
                    <div class="row">
                      <div class="col-6 col-md-12 col-xl-12">
                        <p>
                          <h3 class="card-title mt-4">Active Employees</h3>
                        </p>
                      </div>
                    </div>
                  </div>
                ...
                <div class="card">
                  <div class="card-body">
                    ...
                    <div class="row">
                      <div class="col-6 col-md-12 col-xl-12">
                        <p>
                          <h3 class="card-title mt-4">Inactive Employees</h3>
                        </p>
                      </div>
                    </div>
                  </div>
                ...
                <div class="card">
                  <div class="card-body">
                    ...
                    <div class="row">
                      <div class="col-6 col-md-12 col-xl-12">
                        <p>
                          <h3 class="card-title mt-4">Terminated Employees</h3>
                        </p>
                      </div>
                    </div>
                  </div>
                ...
                <div class="card">
                  <div class="card-body">
                    ...
                    <div class="row">
                      <div class="col-6 col-md-12 col-xl-12">
                        <p>
                          <h3 class="card-title mt-4">Resigned Employees</h3>
                        </p>
                      </div>
                    </div>
                  </div>
          ...
          <div class="col-lg-6 col-xl-6 grid-margin stretch-card">
            <div class="card">
              <div class="card-body">
                ...
                <p class="text-muted mb-4">Description of the information represented on the chart below</p>
                <!-- <div class="monthly-sales-chart-wrapper"> -->
